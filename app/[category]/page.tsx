// ============================================================================
// FILE: app/[category]/page.tsx (UPDATED WITH CATEGORY STATS)
// ============================================================================
...
export default async function CategoryPage({ params }: CategoryPageProps) {
  ...
  // Calculate category stats using helper function
  ...
  return (
    <div className="container mx-auto px-4 py-12 max-w-4xl">
      ...
      <h1 className="text-4xl font-bold mb-8">{category.categoryTitle}</h1>    
